...
# ===========================================================================
HOST = "Manixhor"   # shown as  you@github  in the header
...
ROWS = [
    ...
    ("kv", "Deploy", "Gunicorn, Render, Linux, Docker"),
    ("kv", "Tools", "GitHub, Postman, CI/CD, Bash"),
    ("gap",),
    ("sec", "Projects"),
    ("bul", "Raspberry Pi home server dashboard"),
